...
rem === GM Landmarking: YOLO Trainer (v1.0) ===

rem Landmarking-YOLO module root (LM_ROOT)
set "LM_ROOT=%~dp0"
...
"%PY%" "%LM_ROOT%\scripts\trainer_menu.py" --base-localities "%BASE_LOCALITIES%" 1>>"%LOG_DIR%\trainer_menu_last.log" 2>&1
